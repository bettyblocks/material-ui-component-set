...
const beforeCreate = ({
  ...
  if (modelId === null && validationMessage === '') {
    setValidationMessage(
      'The singleline widget needs to be inside a parent with a model',
    );
  }
  ...
  return (
    <>
      <Header title="Configure your singleline widget" onClose={close} />
      <Content>
        <Field
      ...
      <Footer
        onSave={async (): Promise<void> => {
          ...
          const singlelineWidgetForm = treeSearch(
            '#SingleLineWidgetForm',
            newPrefab.structure,
          );
          ...
          singlelineWidgetForm.id = componentId;
          ...
          singlelineWidgetForm.descendants.push(
            makeBettyUpdateInput(
              BettyPrefabs.HIDDEN,
              model,
              idProperty,
          ...
          const interaction = {
            ...
            parameters: [],
            ref: {
              targetComponentId: '#SingleLineWidgetForm',
...
export default makePrefab('Singleline Widget', attributes, beforeCreate, [
  wrapper(
    {
      label: 'Singleline widget',
      optionCategories: [
        {
