    ...
    <>
      ...
      <Footer
        ...
        onSave={() => {
          ...
          const PrefabContent = getDescendantByRef(
            '#ContentBox',
            newPrefab.structure,
          );
          ...
          if (
            ...
            PrefabContent.descendants[0].descendants[0].options[1] = {
              value: modelId,
              label: 'Model',
              key: 'model',
          ...
          // const dataTable = cloneStructure(prefabs, 'Datatable');
          // console.log('My cloneStructure = ', dataTable);
          save(newPrefab);
        }}
        onSkip={() => {
          const newPrefab = { ...prefab };
                      ...
                      wrapper(
                        {
                          ...
                          options: {
                            keyname: linked({
                              label: 'First datatable reconfigure option',
                              value: {
                                ref: {
                          ...
                          DataTable(
                            {
                              ...
                              options: {
                                ...
                                title: variable('Title', {
                                  ref: { id: '#something' },
                                  value: ['Something something pappel'],
                                }),
                              },
                            },
                            [],
