(() => ({
  name: '500 error - alternative',
  icon: 'NavbarIcon',
  type: 'page',
  description: 'A simple alternative 500 error page.',
  detail: 'A simple alternative 500 error page.',
  previewUrl: 'https://preview.betty.app/500-alternative',
  previewImage:
    'https://assets.bettyblocks.com/efaf005f4d3041e5bdfdd0643d1f190d_assets/files/Page_Template_500_Alternative.jpg',
  category: 'LAYOUT',
  structure: [
    {
      name: 'Row',
                          ...
                          options: [
                            {
                              ...
                              key: 'content',
                              value: [
                                'Seems something is wrong ... Try again later.',
                              ],
                              configuration: {
                                as: 'MULTILINE',
                              },
