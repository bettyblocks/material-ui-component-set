  ...
  beforeCreate: ({
    ...
    const onSaveHandler = () => {
      ...
      if (validate()) {
        ...
        console.log({ passwordFieldsLabels });
        const passwordInputs = passwordFieldsLabels.map((label) =>
          // inputBox(label, passwordProperty),
          inputBox(label),
        );
        console.log({ passwordInputs });

        // const passwordFields = passwordFieldsLabels.map((label) => {
        //   return inputBox(label, passwordProperty);
        // });
        const changePasswordTab = getDescendantByRef(
          '#changePasswordTab',
          prefabStructure,
        );
        console.log({ changePasswordTab });
    ...
    return (
      <>
        ...
        <Content>
          ...
          >
            <AuthenticationProfileSelector
              onChange={(id, authProfileObject) => {
                ...
                console.log({ id, authProfileObject });
          ...
          <Field label="Password property">
            <PropertySelector
              modelId={modelId}
              onChange={(value) => {
                setPasswordProperty(value);
                console.log({ passwordProperty: value });
              }}
