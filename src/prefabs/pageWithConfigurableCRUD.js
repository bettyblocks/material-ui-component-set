(() => ({
  name: 'CRUD with configurable datatable and layout',
  icon: 'DataTable',
  type: 'page',
  description:
    'This page contains a datatable with configurable CRUD and layout.',
  detail:
    'In this ready to use Data Table, it is possible to create, display (read), update and delete records. These functionalities are shown in either a modal or in-page.',
  previewUrl: 't.b.d',
  previewImage: 't.b.d',
  category: 'DATA',
