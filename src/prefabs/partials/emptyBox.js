(() => ({
  name: 'Empty box',
  icon: 'ContainerIcon',
  description: 'This is a plain empty box component',
  detail:
    'This partial has a plain box component. It can be decorated to personal preference.',
  // previewUrl: 'https://preview.betty.app/homepage',
  previewImage:
    'https://assets.bettyblocks.com/bea59bf27f2a414a9ca069afa6524a2b_assets/files/Box',
  category: 'LAYOUT',
