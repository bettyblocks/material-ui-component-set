(() => ({
  ...
  icon: 'TabsIcon',
  description: 'Page with an app bar and configurable tabs',
  type: 'page',
  category: 'LAYOUT',
  beforeCreate: ({
    close,
    ...
    return (
      <>
        <Header onClose={close} title="Configure Tabs Layout" />
        <Content>
          <Box direction="row">
            <Box direction="column" basis="55%">
              <Field
                info={
                  <>
            ...
            >
              ...
              <Box direction="row" background="#4050B5" overflow="hidden">
                {tabs.map(tab => (
                  <Box
                    justify="center"
                    align="center"
                    pad="8px"
                    width={{ min: '60px', max: '100px' }}
                    overflow="hidden"
                  ...
                  >
                    <Text
                      textAlign="center"
                      size="0.575rem"
                      color={tab.index === 1 ? '#FFFFFF' : '#C5CBE9'}
                      style={{
          ...
          <Box pad={{ top: '2rem' }}>
            <Text color="#666d85" size="small">
              Note: The preview may differ from what you will see on the canvas.
              <br />
              It should however give you a good indication of what it will look
              like.
            </Text>
          </Box>
        </Content>
