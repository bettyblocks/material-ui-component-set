(() => ({
  name: '404 error - alternative',
  icon: 'NavbarIcon',
  type: 'page',
  description: 'A simple alternative 404 error page.',
  detail: 'A simple alternative 404 error page.',
  previewUrl: 'https://preview.betty.app/404-alternative',
  previewImage:
    'https://assets.bettyblocks.com/efaf005f4d3041e5bdfdd0643d1f190d_assets/files/Page_Template_404_Alternative.jpg',
  category: 'LAYOUT',
  beforeCreate: ({
    prefab,
    save,
    close,
    components: { EndpointSelector, Header, Content, Field, Footer },
  }) => {
    ...
    const onSaveHandler = () => {
      ...
      newPrefab.structure[0].descendants[0].descendants[0].descendants[0].descendants[1].descendants[2].descendants[0].options[3].value = endpoint
        .id.length
        ? endpoint
        : '';
      save(newPrefab);
    ...
    return (
      <>
        <Header onClose={close} title="Configure 'Go back' button" />
        <Content>
