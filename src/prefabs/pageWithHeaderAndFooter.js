    ...
    return (
      <>
        ...
        <Footer
          ...
          onSkip={() => {
            const newPrefab = { ...prefabStructure };
            newPrefab.structure[0].descendants[0].descendants[0].descendants[0].descendants[0].descendants[0] =
              defaultHeaderstructure;
            newPrefab.structure[0].descendants[0].descendants[0].descendants[0].descendants[2].descendants[0] =
              defaultFooterStructure;
            save(newPrefab);
          }}
        />
      </>
