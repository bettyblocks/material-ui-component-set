...
const beforeCreate = ({
  ...
  const unsupportedKinds = createBlacklist(['INTEGER', 'PHONE_NUMBER']);
  ...
  if (modelId === null && validationMessage === '') {
    setValidationMessage(
      'The Number widget needs to be inside a parent with a model',
    );
  }
  ...
  return (
    <>
      <Header title="Configure your number widget" onClose={close} />
      <Content>
        <Field
      ...
      <Footer
        onSave={async (): Promise<void> => {
          ...
          const numberInput = treeSearch('#NumberInput', newPrefab.structure);
          const numberWidgetForm = treeSearch(
            '#NumberWidgetForm',
            newPrefab.structure,
          );
          ...
          numberWidgetForm.id = componentId;
          ...
          const interaction = {
            ...
            parameters: [],
            ref: {
              targetComponentId: '#NumberWidgetForm',
...
export default makePrefab('Number Widget', attributes, beforeCreate, [
  wrapper(
    {
      label: 'Number widget',
      optionCategories: [
